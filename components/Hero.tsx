  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black px-6 py-16 text-white sm:py-20 lg:py-24">
      ...
      <div className="relative z-10 flex w-full max-w-5xl flex-col items-center text-center">
        ...
        <p className="mt-8 max-w-3xl animate-fade-up animation-delay-500 text-base leading-7 text-gray-300 sm:text-lg">
        ...
        <a
          href="#about"
          className="mt-16 animate-fade-up animation-delay-1200 text-sm text-gray-400 transition hover:text-blue-200 sm:mt-14"
        >
          Scroll to explore ↓
        </a>
      </div>
